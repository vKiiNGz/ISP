...
namespace LR_8
{
    class Game : IComparable<Game>
    {
        ...
        public static void ShortInfo(object Sender, Game x)
        {
            Console.WriteLine("Name of the game: " + x.name);
            Console.WriteLine("Players rating of the game is " + x.playerRating);
            Console.WriteLine("Press rating of the game is " + x.pressRating);
        }
